...
//初始化区域图的对象
	...
	this.$bgDiv.css({width:"100%",height:height+"px"});
	...
	if(property.haveHead){
		tmp="<div class='GooFlow_head'><label style='height:20px;' title='"+(property.initLabelText||"newFlow_1")+"'>"+(property.initLabelText||"newFlow_1")+"</label>";
	...
	if(property.haveTool){
		this.$bgDiv.append("<div class='GooFlow_tool'"+" style='width:3%;' "+(property.haveHead? "":" style='margin-top:3px'")+"><div style='height:"+(height-headHeight-(property.haveHead? 7:10))+"px' class='GooFlow_tool_div'></div></div>");
	...
	this.$bgDiv.append("<div class='GooFlow_work' style='width:95%;height:"+(height)+"px;"+(property.haveHead? "":"margin-top:3px")+"'></div>");
	  ...
	  this.$group.on("mousedown",{inthis:this},function(e){//绑定RESIZE功能以及移动功能
		...
		document.onmousemove=function(e){
			...
			switch(cursor){
				...
				This.$ghost.css({left:X+hack+"px",top:Y+hack-80+"px"});
			}
			isMove=true;
		}
		document.onmouseup=function(e){
	...
	initWorkForNode:function(){
		...
		this.$workArea.delegate(".ico","mousedown",{inthis:this},function(e){
			...
			document.onmousemove=function(e){
				...
				This.$ghost.css({left:X+"px",top:Y-80+"px"});
				isMove=true;
			}
			document.onmouseup=function(e){
		...
		this.$workArea.delegate(".GooFlow_item > .span","dblclick",{inthis:this},function(e){
			...
			This.$textArea.val(oldTxt).css({display:"block",height:$(this).height(),width:100,
				left:This.$nodeData[id].left-This.$workArea[0].parentNode.scrollLeft+50,
				top:t.top+2+This.$nodeData[id].top-This.$workArea[0].parentNode.scrollTop-65})
		...
		this.$workArea.delegate(".ico + td","dblclick",{inthis:this},function(e){
			...
			This.$textArea.val(oldTxt).css({display:"block",width:$(this).width()+24,height:$(this).height(),
				left:This.$nodeData[id].left-This.$workArea[0].parentNode.scrollLeft+90,
				top:t.top+2+This.$nodeData[id].top-This.$workArea[0].parentNode.scrollTop-85})
				.data("id",This.$focus).focus();
			This.$workArea.parent().one("mousedown",function(e){
				if(e.button==2)return false;
				This.setName(This.$textArea.data("id"),This.$textArea.val(),"node");
